...
| [Slop Register](principle-slop-register.md) | Prose must be written from a position that selects its words; register, provenance, and integrity are separate questions. |
...
| [Circular Grounding](heuristic-circular-grounding.md) | A design is justified by the implementation that embodies it → state and verify the independent domain constraint. |
...
| [Tell Laundering](heuristic-tell-laundering.md) | A flagged prose move receives a surface-only substitute → repair above the form and preserve claims. |
| [Coverage Calibration](heuristic-coverage-calibration.md) | Confidence exceeds the examined share of a search space → count coverage and calibrate the claim. |

## Related Files

- [AGENTS.md](AGENTS.md) — operating reference and contradiction handling.
- [CONTRIBUTING.md](CONTRIBUTING.md) — derivation, review, naming, and portability rules.
